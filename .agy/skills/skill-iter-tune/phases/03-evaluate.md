...
> Recovery: `view_file("phases/03-evaluate.md")`
...
const evaluationCriteria = view_file('.claude/skills/skill-iter-tune/specs/evaluation-criteria.md');
...
write_to_file(`${iterDir}/iteration-${N}-eval.md`, evalReport);
