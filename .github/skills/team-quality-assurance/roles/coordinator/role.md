...
- Responsibility: Parse requirements -> Mode selection -> Create team -> Dispatch tasks -> monitor_process progress -> Report results
...
3. Clarify if ambiguous (ask_user: scope, deliverables, constraints)
...
4. create_team with team name "quality-assurance"
...
4. Create tasks via create_task, then update_task with addBlockedBy
