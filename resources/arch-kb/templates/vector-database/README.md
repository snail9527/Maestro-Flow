...
<Quiz
  question="向量数据库为什么用『近似最近邻(ANN)』而不是精确查找?"
  :options="['精确算法写不出来', '在海量高维向量里,用一点精度换巨大的速度', '纯粹为了省钱']"
  :answer="1"
  explanation="精确最近邻在高维 + 海量下慢到不可用;ANN 放弃 100% 准确,换来快几个数量级——『用精度换速度』是处理海量的经典交易。"
/>
