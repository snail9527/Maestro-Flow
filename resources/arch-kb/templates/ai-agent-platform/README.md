...
<Quiz
  question="关于自主 Agent,业界(如 Anthropic)的建议是?"
  :options="['能上自主 Agent 就尽量上,越自主越先进', '能用确定的工作流解决,就别上自主 Agent', '复杂度越高越好']"
  :answer="1"
  explanation="工作流可预测、可控、便宜;自主 Agent 灵活但贵、慢、难控。能确定就别放飞——可预测性是工程美德。"
/>
